...
export default function RadiatorSpecsTable({ selected, deltaT, colorCode, ralCode, connCode, radiatorType, valveType, highPressure, ventType, ventPosition, connSize, ventConnSize }) {
